...
// PB8을 출력설정하고 Alternate function(TIM4_CH3)으로 사용 선언
	GPIOB->MODER 	|= 0x00020000;	//중요 GPIOB PIN8 Output Alternate function mode //왜 20000인가					
	GPIOB->OSPEEDR 	|= 0x00030000;	// GPIOB PIN8 Output speed (100MHz High speed) //보통 25MHz 
...
// TIM4 Channel 3 : PWM 1 mode
	...
	//나누기를 해서 소수점이 나오면 안된다.... 정수가 계산하기 편해서 
	TIM4->ARR	= 100-1;	// Auto reload  (0.1ms * 100 = 10ms : PWM Period)
	//10ms와 0.1ms는 100배차이 6만이 넘어가면 안된다... 왜? 16비트라서... 
	// CR1 : Up counting
